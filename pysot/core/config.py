...
__C.DATASET.LMDTSHIP = CN()
__C.DATASET.LMDTSHIP.ROOT = 'training_dataset/lmdtship/crop511'
__C.DATASET.LMDTSHIP.ANNO = 'training_dataset/lmdtship/train.json'
__C.DATASET.LMDTSHIP.FRAME_RANGE = 3
__C.DATASET.LMDTSHIP.NUM_USE = -1  # use all not repeat
